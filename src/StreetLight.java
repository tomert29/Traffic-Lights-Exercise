...
class StreetLight {
    ...
    StreetLight(int num, int dia, int x0, int y0) {
        numOfLights = num;
        diameter = dia;
    ...
    StreetLight(int num, int dia, int x0, int y0, int x1, int y1) {
        numOfLights = num;
        diameter = dia;
        xP = new int[numOfLights];
        yP = new int[numOfLights];
    ...
    StreetLight(int num, int dia, int x0, int y0, int x1, int y1, int x2, int y2) {
        numOfLights = num;
        diameter = dia;
        xP = new int[numOfLights];
        yP = new int[numOfLights];
